...
try:
    ...
    register_flow('optimize', ['eliminate_linear_activation', 'fuse_consecutive_batch_normalization', 'fuse_batch_normalization', 'set_precision_concat'], requires=['convert']) # 'replace_multidimensional_dense_with_conv',
except:
    register_flow('convert', ['fuse_bias_add', 'remove_useless_transpose'])
    register_flow('optimize', ['eliminate_linear_activation', 'fuse_batch_normalization', 'set_precision_concat'], requires=['convert']) # 'replace_multidimensional_dense_with_conv',
